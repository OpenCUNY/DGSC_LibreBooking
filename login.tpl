		...
		<form role="form" name="login" id="login" class="form-horizontal" method="post"
			...
			<div id="login-box" class="col-xs-12 default-box">
				<div class="col-xs-12 login-icon">
					...
					<h2>Welcome to the DGSC Room Reservations Portal!</h2>
					<p>If you already have an account, login below to manage your bookings or create a new one. Otherwise, <a href="{$RegisterUrl}">register</a>.</p>
				</div>
